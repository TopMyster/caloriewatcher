   let malecb = document.getElementById('male')
            ...
            function submition() {
                ...
                if (malecb.checked) {
                    result =  [66 + (6.23 * document.getElementById('weight').value) + (12.7 * (Number(document.getElementById('height').value) * 12)) - (6.8 * document.getElementById('age').value)] * ActivityFactor - 500
                }
                 if (femalecb.checked) {
